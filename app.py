...
app = Flask(__name__)
CORS(app, resources={r"/api/*": {"origins": ["https://instagraphix.pro", "https://www.instagraphix.pro","https://api.instagraphix.pro"]}}, supports_credentials=True)
...
google = oauth.register(
    ...
    client_secret='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',
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        print("Session in decorator:", session)
